...
![Assistant de démarrage Stripe](/static/docs/images/stripe-onboarding-wizard.png)
...
![Page Clés API Stripe en mode test](/static/docs/images/stripe-api-keys-test-mode.png)

Une fois connecté, vous accédez au tableau de bord Stripe :

![Tableau de bord Stripe](/static/docs/images/stripe-dashboard-home.png)

**3.1** Dans le menu de gauche, cliquez sur **Developers** (tout en bas).

**3.2** Cliquez sur **API keys**. La page suivante s'affiche :

![Page Clés API Stripe](/static/docs/images/stripe-api-keys.png)
...
![Options de la clé secrète](/static/docs/images/stripe-api-keys-reveal.png)
...
![Page Webhooks Stripe](/static/docs/images/stripe-webhooks-page.png)
...
![Sélection des événements](/static/docs/images/stripe-add-destination-events.png)
...
![Les deux événements sélectionnés](/static/docs/images/stripe-events-both-selected.png)
...
![Choisir le type de destination](/static/docs/images/stripe-destination-type.png)
...
![Configurer l'URL du webhook](/static/docs/images/stripe-configure-endpoint-filled.png)
...
![Paramètres Stripe dans Minipass](/static/docs/images/minipass-stripe-settings.png)
...
![Option carte de crédit dans l'activité](/static/docs/images/minipass-activity-credit-card.png)
...
![Choix de méthode de paiement](/static/docs/images/minipass-signup-payment-methods.png)
