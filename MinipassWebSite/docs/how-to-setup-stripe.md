...
1. Rendez-vous sur **[https://dashboard.stripe.com/register](https://dashboard.stripe.com/register)**
   ...
   ![Page d'inscription Stripe](images/stripe-signup-page.png)
...
3. Remplissez les informations suivantes :
   ...
   | Champ | Valeur |
   |-------|--------|
   | **Endpoint URL** | `https://VOTRE-SOUS-DOMAINE.minipass.me/stripe/webhook` |
   | **Events to send** | `checkout.session.completed` |

   Par exemple, si votre sous-domaine est `lhgi`, l'URL sera :
   ```
...
3. Faites defiler jusqu'a la section **Credit Card Settings (Stripe)** et cliquez dessus pour l'ouvrir
   ...
   ![Section Stripe dans les parametres Minipass](images/minipass-stripe-settings.png)
...
2. Dans la section **Signup Settings**, vous verrez maintenant l'option :
   ...
   **Accept credit card payments (Stripe)**
   ...
   ![Option carte de credit dans le formulaire d'activite](images/minipass-activity-credit-card.png)
...
![Choix de methode de paiement lors de l'inscription](images/minipass-signup-payment-methods.png)
...
- Verifiez que l'URL du webhook est exacte : `https://VOTRE-SOUS-DOMAINE.minipass.me/stripe/webhook`
